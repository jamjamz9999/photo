...
const HomePage = () => {
  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      <section id="portfolio" className="bg-gradient-to-b from-gray-50 via-white to-gray-50 py-16 sm:py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 sm:gap-8 mb-12 sm:mb-14 md:mb-16">
            <div className="space-y-3">
              <p className="text-xs sm:text-sm uppercase tracking-[0.4em] text-gray-500 font-medium">Featured Collections</p>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black">Curated Stories with Luminous Detail</h2>
            </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            {featuredCollections.map((collection) => (
              <div
                ...
                className="group relative rounded-3xl overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105"
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
                  <div className="rounded-2xl bg-white/95 backdrop-blur-md p-6 sm:p-7 shadow-lg">
                    <h3 className="text-2xl sm:text-3xl font-bold text-black">{collection.title}</h3>
                    ...
                    <div className="mt-5 flex items-center justify-between text-xs uppercase tracking-[0.35em] text-gray-600 font-medium">
                      ...
                      <span className="flex items-center gap-2 text-black group-hover:translate-x-1 transition-transform">
                        Explore
